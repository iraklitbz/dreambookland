<template>
    <div class="body-content login-page container max-width-adaptive-xs">

<form class="login-form margin-top-lg">
  ...
  <div class="margin-bottom-sm">
    <div class="flex justify-between margin-bottom-xxxs">
      ...
      <span class="text-sm"><a href="/login/password-reset">Forgot?</a></span>
    </div>
